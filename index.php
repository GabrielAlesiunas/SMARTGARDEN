...
<body>
    ...
    <main class="main">
        ...
        <!-- <div id="myModal1" class="modalProduto">
            <div class="modal-overlay" onclick="closeModal1()"></div>
            <div class="modal-content">
                <span class="close-button-product" onclick="closeModal1()">&times;</span>
                <h2 class="modalTitulo">Cacto castelo de fada</h2>
                <p class="modalDescricao">Não damos garantia para plantas enviadas por PAC.
                    Não nos responsabilizamos por atrasos nos Correios.
                </p>
                <div class="slider">
                    <div class="buttons left">
                        <button class="arrow-icon" onclick="prevSlide()"><i class="fas fa-chevron-left"></i></button>
                    </div>
                    <img src="assets/img/product1.png" alt="Imagem 1" class="slide">
                    <img src="assets/img/product2.png" alt="Imagem 2" class="slide">
                    <img src="assets/img/product3.png" alt="Imagem 3" class="slide">
                    <div class="buttons right">
                        <button class="arrow-icon" onclick="nextSlide()"><i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>

                <p class="modalPreco">R$ 19,90</p>
                <a href='https://www.mercadolivre.com.br' target="_blank"><button class="btnAddCart">Comprar</button></a>
            </div>
        </div>


        <div id="myModal2" class="modalProduto">
            <div class="modal-overlay" onclick="closeModal2()"></div>
            <div class="modal-content">
                <span class="close-button-product" onclick="closeModal2()">&times;</span>
                <h2 class="modalTitulo">Kit Mini Suculentas com 20 unidades</h2>
                <p class="modalDescricao">Kit com 20 mudas de suculentas no pote número 6.
                    Neste kit todas as suculentas vão conforme a disponibilidade da produção.
                    Todas as suculentas estão enraizadas e vão plantadas no vasinho.
                </p>
                <div class="slider">
                    <div class="buttons left">
                        <button class="arrow-icon" onclick="prevSlide()"><i class="fas fa-chevron-left"></i></button>
                    </div>
                    <img src="assets/img/suculenta.png" alt="Imagem 1" class="slide">
                    <img src="assets/img/product2.png" alt="Imagem 2" class="slide">
                    <img src="assets/img/product3.png" alt="Imagem 3" class="slide">
                    <div class="buttons right">
                        <button class="arrow-icon" onclick="nextSlide()"><i class="fas fa-chevron-right"></i></button>
                ...
                <p class="modalPreco">R$ 46,99</p>
                <a href='https://www.mercadolivre.com.br' target="_blank"><button class="btnAddCart">Comprar</button></a>
            </div>
        </div>


        <div id="myModal3" class="modalProduto">
            <div class="modal-overlay" onclick="closeModal3()"></div>
            <div class="modal-content">
                <span class="close-button-product" onclick="closeModal3()">&times;</span>
                <h2 class="modalTitulo">Orquídea Amarela</h2>
                <p class="modalDescricao">Contém 1 PLANTA SELECIONADA. Orquídea Dendrobium Agregatum adulta.
                ...
                <div class="slider">
                    ...
                    <img src="assets/img/orquidea amarela.png" alt="Imagem 1" class="slide">
                    <img src="assets/img/product2.png" alt="Imagem 2" class="slide">
                    <img src="assets/img/product3.png" alt="Imagem 3" class="slide">
                    <div class="buttons right">
                        <button class="arrow-icon" onclick="nextSlide()"><i class="fas fa-chevron-right"></i></button>
                ...
                <p class="modalPreco">R$ 39,99</p>
                <a href='https://www.mercadolivre.com.br' target="_blank"><button class="btnAddCart">Comprar</button></a>
            </div>
        </div>


        <div id="myModal4" class="modalProduto">
            <div class="modal-overlay" onclick="closeModal4()"></div>
            <div class="modal-content">
                <span class="close-button-product" onclick="closeModal4()">&times;</span>
                <h2 class="modalTitulo">Terra Vegetal Adubada 2,4kg Composto Orgânico</h2>
                <p class="modalDescricao">Terra Vegetal Adubada 2,4 quilos Composto Orgânico Mercshop.
                </p>
                <div class="slider">
                    <div class="buttons left">
                        <button class="arrow-icon" onclick="prevSlide()"><i class="fas fa-chevron-left"></i></button>
                    </div>
                    <img src="assets/img/terra vegetal.png" alt="Imagem 1" class="slide">
                    <img src="assets/img/product2.png" alt="Imagem 2" class="slide">
                    <img src="assets/img/product3.png" alt="Imagem 3" class="slide">
                    <div class="buttons right">
                        <button class="arrow-icon" onclick="nextSlide()"><i class="fas fa-chevron-right"></i></button>
                ...
                <p class="modalPreco">R$ 13,50</p>
                <a href='https://www.mercadolivre.com.br' target="_blank"><button class="btnAddCart">Comprar</button></a>
            </div>
        </div>

        <div id="myModal5" class="modalProduto">
            <div class="modal-overlay" onclick="closeModal5()"></div>
            <div class="modal-content">
                <span class="close-button-product" onclick="closeModal5()">&times;</span>
                <h2 class="modalTitulo">Fertilizante Grow Bokashi 3 Kg </h2>
                <p class="modalDescricao">Bokashi Premium 3kg
                    Composição:
                    BAMBU MOÍDO, PÓ DE ARROZ, MELAÇO DE CANA DE AÇÚCAR, FARINHA DE PEIXE, TORTA VEGETAL DE NEEM, PÓ DE CARVÃO, ALGAS MARINHAS.
                </p>
                <div class="slider">
                    <div class="buttons left">
                        <button class="arrow-icon" onclick="prevSlide()"><i class="fas fa-chevron-left"></i></button>
                    </div>
                    <img src="assets/img/fertilizante.png" alt="Imagem 1" class="slide">
                    <img src="assets/img/product2.png" alt="Imagem 2" class="slide">
                    <img src="assets/img/product3.png" alt="Imagem 3" class="slide">
                    <div class="buttons right">
                        <button class="arrow-icon" onclick="nextSlide()"><i class="fas fa-chevron-right"></i></button>
                ...
                <p class="modalPreco">R$ 41,67</p>
                <a href='https://www.mercadolivre.com.br' target="_blank"><button class="btnAddCart">Comprar</button></a>
            </div>
        </div>

        <div id="myModal6" class="modalProduto">
            <div class="modal-overlay" onclick="closeModal56()"></div>
            <div class="modal-content">
                <span class="close-button-product" onclick="closeModal6()">&times;</span>
                <h2 class="modalTitulo">Kit 10 Arandelas Vasos De Plástico Suporte Parede Plantas </h2>
                <p class="modalDescricao">Kit 10 arandelas
                    Cor: Preto;
                    Vaso e Arandela;
                    VASO: 16cm x 8cm x 8,5cm;
                    SUPORTE: 33x22 cm;
                    Quantidade: 10;
                </p>
                <div class="slider">
                    ...
                    <img src="assets/img/arandelas.png" alt="Imagem 1" class="slide">
                    <img src="assets/img/product2.png" alt="Imagem 2" class="slide">
                    <img src="assets/img/product3.png" alt="Imagem 3" class="slide">
                    <div class="buttons right">
                        <button class="arrow-icon" onclick="nextSlide()"><i class="fas fa-chevron-right"></i></button>
